...
use ibc_proto_sov::ibc::lightclients::sovereign::tendermint::v1::ConsensusState as RawConsensusState;
use tendermint::Time;
...
impl From<SovTmConsensusState> for RawConsensusState {
    fn from(value: SovTmConsensusState) -> Self {
        RawConsensusState {
            root: Some(ibc_proto_sov::ibc::core::commitment::v1::MerkleRoot {
