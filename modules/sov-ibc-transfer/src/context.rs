...
impl<'ws, C> TokenTransferValidationContext<EscrowExtraData<C>> for IbcTransferContext<'ws, C>
where
    C: Context,
{
...
impl<'ws, C> TokenTransferExecutionContext<EscrowExtraData<C>> for IbcTransferContext<'ws, C>
where
    C: Context,
{
